const __vite__fileDeps=["./index.CD7fM5HH.js","./index.BvLrxrPo.js","./index.C2JDE2Nm.js","./index.CQHkCe1I.js","./index.DNkyN8w7.js","./index.CGaCy45h.js","./frontmatter.jhgHDcjn.js","./yaml.BMKOA8H-.js","./index.Dgx-bPsS.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, t as Check, v as Copy$1, B as Block, S as Static } from "./2.y7UIYSlv.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.CD7fM5HH.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.C2JDE2Nm.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.jhgHDcjn.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.Dgx-bPsS.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.CQHkCe1I.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.DNkyN8w7.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.CGaCy45h.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.CGaCy45h.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
