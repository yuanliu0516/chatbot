const __vite__fileDeps=["./vega-embed.module.k17u_GeP.js","./2.y7UIYSlv.js","./preload-helper.DpQnamwV.js","./stores.Di-mbd2-.js","./client.nYcIsa0Y.js","../assets/2.LFdiizIE.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, h as BlockTitle, S as Static } from "./2.y7UIYSlv.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.k17u_GeP.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url)).default;
    }
